...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1685470205').split()]
...
support_chat_id = environ.get('-1002402827530')
reqst_channel = environ.get('-1002402827530')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "PRIVATE")
...
LOG_CHANNEL = int(environ.get('-1002206233283', 0))
